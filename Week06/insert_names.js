// insert_names.js
// The script in this document has an array of names, name_list, whose values are in alphabetic order.
// New names are input through prompt. Each new name is inserted into the name array, after which the new list is displayed.
